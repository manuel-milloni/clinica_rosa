...
const createProfesional = async (req, res) => {
  ...
  try {
    ...
    if (error.name === 'SequelizeUniqueConstraintError') {
      // Verificar el tipo de restricción única violada
      ...
      switch (constraintType) {
        case 'unique violation':
          // Aquí puedes verificar el path para determinar qué campo está duplicado
...
module.exports = {
  getAllPacientes, getTurnosByProfesional,
